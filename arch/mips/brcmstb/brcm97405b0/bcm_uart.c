...
uart_putc(char c)
{
#if defined(HUMAX_LINUX_HARDENING)
#else
	#if defined(HUMAX_UART_A)
	return serial_putc(UARTA_ADR_BASE, c);
	#elif defined(HUMAX_UART_B)
	return serial_putc(UARTB_ADR_BASE, c);
	#endif
#endif
}
