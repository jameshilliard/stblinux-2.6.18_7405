...
UINT32  TXRPT:
    1;
UINT32  Autofallback:
    1; // TX rate auto fallback disable
UINT32  NDPSndBW:
    1; // NDP sounding BW
UINT32  NDPSndRate:
    2; // 0 : MCS0, 1: MCS8, 2: MCS16, 3: reserved
#else
UINT32  rsv:
    6;
#endif // RT3593 //
...
UINT32        BigEndian:
        1;
UINT32        EnTXWriteBackDDONE:
        1;
UINT32        WPDMABurstSIZE:
        2;
UINT32  RxDMABusy:
        1;
UINT32  EnableRxDMA:
...
ULONG Reserved5:
        12; // Reserved
ULONG SHR_MSEL:
        1; // Shared memory access selection
ULONG PBF_MSEL:
        2; // Packet buffer memory access selection
ULONG HST_PM_SEL:
        1; // The write selection of the host program RAM
ULONG Reserved4:
        1; // Reserved
ULONG CAP_MODE:
        1; // Packet buffer capture mode
ULONG Reserved3:
        1; // Reserved
ULONG CLK_SEL:
        1; // MAC/PBF clock source selection
ULONG PBF_CLK_EN:
        1; // PBF clock enable
ULONG MAC_CLK_EN:
        1; // MAC clock enable
...
ULONG Reserved1:
        2; // Reserved
ULONG ASY_RESET:
        1; // ASYNC interface reset
ULONG PBF_RESET:
        1; // PBF hardware reset
ULONG MAC_RESET:
        1; // MAC hardware reset
ULONG DMA_RESET:
        1; // DMA hardware reset
ULONG MCU_RESET:
        1; // MCU hardware reset
    } field;
...
typedef union _TX_CHAIN_ADDR0_L_STRUC
{
    ...
    {
ULONG TxChainAddr0L:
        32; // Destination MAC address bit 31~0 of Tx chain0
    } field;
...
ULONG Reserved:
        12; // Reserved
ULONG TxChainSel0:
        4; // Selection value of Tx chain0
ULONG TxChainAddr0H:
        16; // Destination MAC address bit 47~32 of Tx chain0
    } field;
...
UINT32  :
        16;
UINT32  EnableAutoWakeup:
        1; // 0:sleep, 1:awake
UINT32       NumofSleepingTbtt:
...
UINT32       TxopAllowGF40:
        1; //CCK TXOP allowance.0:disallow.
UINT32       TxopAllowGF20:
        1; //CCK TXOP allowance.0:disallow.
UINT32       TxopAllowMM40:
        1; //CCK TXOP allowance.0:disallow.
UINT32       TxopAllowMM20:
        1; //CCK TXOP allowance. 0:disallow.
UINT32       TxopAllowOfdm:
        1; //CCK TXOP allowance.0:disallow.
UINT32       TxopAllowCck:
        1; //CCK TXOP allowance.0:disallow.
UINT32       ProtectNav:
...
UINT32       rsv:
        1;   // Power bit value in conrtrol frame
UINT32       AutoResponderPreamble:
        1;    // 0:long, 1:short preamble
UINT32       CTS40MRef:
        1;  // Response CTS 40MHz duplicate mode
UINT32       CTS40MMode:
        1;  // Response CTS 40MHz duplicate mode
UINT32       BACAckPolicyEnable:
        1;    // 0:long, 1:short preamble
UINT32       AutoResponderEnable:
        1;
    } field;
    UINT32   word;
...
UINT32  eTxBF:
        1; // eTxBF enable
UINT32  SuccessRate:
        11; //include MCS, mode ,shortGI, BW settingSame format as TXWI Word 0 Bit 31-16.
#else
UINT32  TxBF:
        1; // 3*3
UINT32  SuccessRate:
...
typedef union _SHAREDKEY_MODE_STRUC
{
    struct
    {
UINT32       Bss1Key3CipherAlg:
        4;
UINT32       Bss1Key2CipherAlg:
        4;
UINT32       Bss1Key1CipherAlg:
        4;
UINT32       Bss1Key0CipherAlg:
        4;
UINT32       Bss0Key3CipherAlg:
        4;
UINT32       Bss0Key2CipherAlg:
        4;
UINT32       Bss0Key1CipherAlg:
        4;
UINT32       Bss0Key0CipherAlg:
        4;
    } field;
    UINT32   word;
...
UINT32       :
        1;
UINT32       Bss3Key3CipherAlg:
        3;
UINT32       :
        1;
UINT32       Bss3Key2CipherAlg:
        3;
UINT32       :
        1;
UINT32       Bss3Key1CipherAlg:
        3;
UINT32       :
        1;
UINT32       Bss3Key0CipherAlg:
        3;
UINT32       :
        1;
UINT32       Bss2Key3CipherAlg:
        3;
UINT32       :
        1;
UINT32       Bss2Key2CipherAlg:
        3;
UINT32       :
        1;
UINT32       Bss2Key1CipherAlg:
        3;
UINT32       :
        1;
UINT32       Bss2Key0CipherAlg:
        3;
    } field;
    UINT32   word;
...
ULONG Rsvd2:
        2; // Reserved
ULONG TESTCSR_RFACC_REGNUM:
        6; // RF register ID (R0~R63)
ULONG RF_CSR_DATA:
        8; // Data
    } field;
