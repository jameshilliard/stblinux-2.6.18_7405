...
USHORT  Rsv2:
        1;     // must be 0
USHORT  bInternalTxALC:
        1; // Internal Tx ALC
USHORT  AntOpt:
        1; // Fix Antenna Option: 0:Main; 1: Aux
#else
USHORT  Rsv2:
        3;     // must be 0
#endif // RTMP_INTERNAL_TX_ALC //
...
USHORT  BW40MAvailForG:
        1;   // 0:enable, 1:disable
USHORT  EnableWPSPBC:
        1;                 // WPS PBC Control bit
USHORT  BW40MSidebandForA:
        1;
USHORT  BW40MSidebandForG:
        1;
USHORT  CardbusAcceleration:
        1; // !!! NOTE: 0 - enable, 1 - disable
USHORT  ExternalLNAForA:
        1;   // external LNA enable for 5G
USHORT  ExternalLNAForG:
        1;   // external LNA enable for 2.4G
USHORT  DynamicTxAgcControl:
        1;   //
USHORT  HardwareRadioControl:
