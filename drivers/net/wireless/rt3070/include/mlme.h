...
{
#ifdef RT_BIG_ENDIAN
USHORT LSIGTxopProSup:
    1;
USHORT Forty_Mhz_Intolerant:
    1;
USHORT PSMP:
    1;
USHORT CCKmodein40:
...
ULONG rsv:
    3;
ULONG ChanEstimation:
    2;
ULONG CSIRowBFSup:
    2;
ULONG ComSteerBFAntSup:
    2;
ULONG NoComSteerBFAntSup:
    2;
ULONG CSIBFAntSup:
    2;
ULONG MinGrouping:
...
ULONG ExpCSIFbk:
    2;
ULONG ExpComSteerCapable:
    1;
ULONG ExpNoComSteerCapable:
    1;
ULONG ExpCSICapable:
    1;
ULONG Calibration:
    2;
ULONG ImpTxBFCapable:
    1;
ULONG TxNDPCapable:
    1;
ULONG RxNDPCapable:
    1;
ULONG TxSoundCapable:
    1;
ULONG RxSoundCapable:
    1;
ULONG TxBFRecCapable:
    1;
#else
ULONG TxBFRecCapable:
    1;
...
UCHAR ExpCSIFbk:
    1;
UCHAR AntIndFbkTxASEL:
    1;
UCHAR ExpCSIFbkTxASEL:
    1;
UCHAR AntSelect:
    1;
#else
...
UCHAR rsv:
        3;
UCHAR ObssScanExempGrant:
        1;
UCHAR ObssScanExempReq:
        1;
UCHAR BSS20WidthReq:
        1;
UCHAR Intolerant40:
...
UCHAR rsv2:
    5;
UCHAR ExtendChannelSwitch:
    1;
UCHAR rsv:
    1;
UCHAR BssCoexistMgmtSupport:
    1;
#else
UCHAR BssCoexistMgmtSupport:
    1;
