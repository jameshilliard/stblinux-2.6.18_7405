...
========================================================================
*/
NTSTATUS ATE_RT3572WriteBBPR66(
    IN PRTMP_ADAPTER pAd,
    IN UCHAR   Value)
{
    ...
    RTUSBReadBBPRegister(pAd, BBP_R27, &BBPData);

    // R66 controls the gain of Rx0
    BBPData &= ~(0x60);// clear bit 5,6
    RTUSBWriteBBPRegister(pAd, BBP_R27, BBPData);
    RTUSBWriteBBPRegister(pAd, BBP_R66, Value);
