...
RTMP_REG_PAIR MACRegTable[] =
{
    ...
    */
    ...
    , /* 0x3800(e0), 0x3A00(e8), 0x3C00(f0), 0x3E00(f8), 512B for each beacon */
...
#ifdef RT35xx
    /* init as unsed value to ensure driver will set to MCU once */
    pAd->ate.LedIndicatorStrength = 0xFF;
    /* stored for hardware reset of BBP */
    ASSERT(IS_RT3572(pAd));
// pAd->ate.RfIcType = RFIC_3052;
#endif // RT35xx //
#endif // RTMP_MAC_USB //
