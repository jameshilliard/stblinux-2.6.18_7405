...
typedef union _TXOP_THRESHOLD_CFG_STRUC
{
    struct
    {
UINT32 TXOP_REM_THRES:
        8; // Remaining TXOP threshold (unit: 32us)
UINT32 CF_END_THRES:
        8; // CF-END threshold (unit: 32us)
UINT32 RDG_IN_THRES:
        8; // Rx RDG threshold (unit: 32us)
UINT32 RDG_OUT_THRES:
        8; // Tx RDG threshold (unit: 32us)
    } field;
