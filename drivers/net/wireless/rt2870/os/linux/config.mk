...
ifeq ($(PLATFORM),ST)
CFLAGS := -DCONFIG_WPS_SUPPORT=1 -nostdinc -D__KERNEL__ -I$(LINUX_SRC)/include -I$(RT28xx_DIR)/include  -nostdinc -isystem /opt/softs/compilers/st/st40/LINUX_4.2.4.final//STLinux-2.3/devkit/sh4_uclibc/bin/../lib/gcc/sh4-linux-uclibc/4.2.4/include -D__KERNEL__ -Iinclude  -include include/linux/autoconf.h -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -O2 -pipe -m4 -m4-nofpu -m4-300 -m4-300-nofpu -ml -Wa,-isa=st40-300-up -ffreestanding -fno-omit-frame-pointer -fno-optimize-sibling-calls  -fno-stack-protector -Wdeclaration-after-statement -Wno-pointer-sign  $(WFLAGS)
...
ifeq ($(PLATFORM),PC)
	...
	# Linux 2.6
	#EXTRA_CFLAGS := $(WFLAGS) -I$(RT28xx_DIR)/include
  EXTRA_CFLAGS := -DCONFIG_WPS_SUPPORT=1 -nostdinc -D__KERNEL__ -I$(RT28xx_DIR)/include -Iinclude  -include include/linux/autoconf.h -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -O2 -pipe -Wa, -ffreestanding -fno-omit-frame-pointer -fno-optimize-sibling-calls  -fno-stack-protector -Wdeclaration-after-statement -Wno-pointer-sign $(WFLAGS)
    endif
endif
