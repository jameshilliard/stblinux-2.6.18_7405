...
ifdef HUMAX_LINUX_HARDENING
CFLAGS += -DHUMAX_LINUX_HARDENING
endif

ifdef HUMAX_GENKERNEL
CFLAGS += -DHUMAX_GENKERNEL
endif

ifdef HUMAX_16MB_NOR
CFLAGS += -DHUMAX_16MB_NOR
endif

ifdef HUMAX_32MB_NOR
CFLAGS += -DHUMAX_32MB_NOR
endif

ifdef HUMAX_64MB_NOR
CFLAGS += -DHUMAX_64MB_NOR
endif
...
ifdef HUMAX_UART_A
CFLAGS += -DHUMAX_UART_A
endif

ifdef HUMAX_UART_B
CFLAGS += -DHUMAX_UART_B
endif

ifdef HUMAX_FLASH_P33
CFLAGS += -DHUMAX_FLASH_P33
endif

ifdef CONFIG_MTD_OTP
CFLAGS += -DCONFIG_MTD_OTP
endif

ifdef HUMAX_FLASH_J3D
CFLAGS += -DHUMAX_FLASH_J3D
endif

ifdef HUMAX_NOR_WP_GPIO
CFLAGS += -DHUMAX_NOR_WP_GPIO=$(HUMAX_NOR_WP_GPIO)
endif
